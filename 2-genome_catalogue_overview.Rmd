---
title: "2-Genome catalogue overview"
...
```{r genome_phylogeny, message=FALSE}
...
```{r genome_quality, message=FALSE}
...
```{r function_heatmap, message=FALSE}
...
```{r function_ordination, message=FALSE}
