...
fitname = "hmsc/fit_model1_250_100.Rdata"
convname = "hmsc/conv_model1_250_100.Rdata"
sample = 250
thin = 100
nchains = 4
...
save(psrf.beta.model1_250_100, psrf.gamma.model1_250_100, psrf.rho.model1_250_100, file=convname)
