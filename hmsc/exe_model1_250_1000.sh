...
fitname = "hmsc/fit_model1_250_1000.Rdata"
convname = "hmsc/conv_model1_250_1000.Rdata"
sample = 250
thin = 1000
nchains = 4
...
save(psrf.beta.model1_250_1000, psrf.gamma.model1_250_1000, psrf.rho.model1_250_1000, file=convname)
